...
export default function AdmitStudent() {
      ...
      <div className="container d-flex flex-column">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="row mb-3">
            ...
            {errors.DOB && (
              <span className="alert alert-danger">{errors.DOB.message}</span>
            )}
          </div>
          <div className="row mb-3">
          ...
          <div className="row mb-3">
            <label htmlFor="permanentAddr" className="col-sm-3 col-form-label">
              Permanent Address
            </label>
            <div className="col-sm-7">
              <input
          ...
          <div className="row mb-3">
            <label htmlFor="houseDistance" className="col-sm-3 col-form-label">
          ...
          <div className="row mb-3">
            <label htmlFor="motherAadhaar" className="col-sm-3 col-form-label">
              Mother Aadhaar
            </label>
            <div className="col-sm-7">
              <input
          ...
          <div className="row mb-3">
            <label htmlFor="motherPhoto" className="col-sm-3 col-form-label">
              Mother Photo
            </label>
            <div className="col-sm-7">
              <input
  ...
  if (metaData.loading) {
    ...
    return <Base title="Admission Page">{admissionForm()}</Base>;
  }
}
